...
class Test_zhjk_sbjk_tb:
    ...
    #点击头孢堡隧道
    @allure.step("点击头孢堡隧道")
    def dl_zhjk_sbjk_tb_01(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_tbsd))
        self.driver.find_element(*loc.dl_zhjk_sbjk_tbsd).click()


    #左侧搜索框
    @allure.step("左侧搜索框")
    def dl_zhjk_sbjk_tb_02(self,ssk):
    ...
    #情报板信息下发---输入内容
    def dl_zhjk_sbjk_tb_012(self,k1):
    ...
    # 可变速标志---速度设置
    def dl_zhjk_sbjk_tb_016(self,r):
    ...
    #枪机 ---视频 点击X
    def dl_zhjk_sbjk_tb_023(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_sdszssk_qx))
        self.driver.find_element(*loc.dl_zhjk_sbjk_sdszssk_qx).click()

    # 左下侧设备名称
    def dl_zhjk_sbjk_tb_025(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_sdszssk_sd))
        return self.driver.find_elements(*loc.dl_zhjk_sbjk_sdszssk_sd)[0].text


    #路段点击设备组
    def dl_zhjk_sbjk_tb_026(self):
    ...
    #点击键盘上的回车键
    def dl_zhjk_sbjk_tb_027(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_zcssk))
        self.driver.find_element(*loc.dl_zhjk_sbjk_zcssk).send_keys(Keys.ENTER)


    #双面车道指示器-------他是进行还原最初状态的
    def dl_zhjk_sbjk_tb_029(self,a1,access_web):
        if a1=="远程正面通行":
            # 点击双面车道指示器状态---远程正面通行
            time.sleep(5)
            ...
            time.sleep(3)
            assert access_web[34].dl_zhjk_sbjk_tb_09() == "远程转向"




    # 射流风机--------他是进行还原最初状态的
    def dl_zhjk_sbjk_tb_030(self, a2, access_web):
        if a2 =="远程关":
            # 射流风机  远程关
            time.sleep(70)
            access_web[34].dl_zhjk_sbjk_tb_05()
            ...
            assert access_web[34].dl_zhjk_sbjk_tb_tsy1() == "设备控制成功"
            time.sleep(2)
            assert access_web[34].dl_zhjk_sbjk_tb_09() == "远程正转"
            ...
            assert access_web[34].dl_zhjk_sbjk_tb_tsy1() == "设备控制成功"
            time.sleep(2)
            assert access_web[34].dl_zhjk_sbjk_tb_09() == "远程反转"
        # 洞口交通灯4控--------他是进行还原最初状态的
    ...
    def dl_zhjk_sbjk_tb_031(self, a2, access_web):
        if a2 == "远程红":
            # 射流风机  远程红
            time.sleep(5)
    ...
    #加强照明----获取他的初始值
    def dl_zhjk_sbjk_tb_035(self,a2,access_web):
