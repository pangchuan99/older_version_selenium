...
class Test_zhjk_sbjk_lqk:
    ...
    # 提示语1---
    @allure.step("提示语1---")
    def dl_zhjk_sbjk_lqk_tsy1(self):
    ...
    #点击龙泉口隧道
    @allure.step("点击龙泉口隧道")
    def dl_zhjk_sbjk_lqk_01(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_lqksd))
        self.driver.find_element(*loc.dl_zhjk_sbjk_lqksd).click()


    #左侧搜索框
    @allure.step("左侧搜索框")
    def dl_zhjk_sbjk_lqk_02(self,ssk):
    ...
    # 可变速标志---速度设置
    def dl_zhjk_sbjk_lqk_016(self,r):
    ...
    #枪机 ---视频 点击X
    def dl_zhjk_sbjk_lqk_023(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_sdszssk_qx))
        self.driver.find_element(*loc.dl_zhjk_sbjk_sdszssk_qx).click()

    # 左下侧设备名称
    def dl_zhjk_sbjk_lqk_025(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_sdszssk_sd))
        return self.driver.find_elements(*loc.dl_zhjk_sbjk_sdszssk_sd)[0].text


    #路段点击设备组
    def dl_zhjk_sbjk_lqk_026(self):
    ...
    #点击键盘上的回车键
    def dl_zhjk_sbjk_lqk_027(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_zcssk))
        self.driver.find_element(*loc.dl_zhjk_sbjk_zcssk).send_keys(Keys.ENTER)


    #双面车道指示器-------他是进行还原最初状态的
    def dl_zhjk_sbjk_lqk_029(self,a1,access_web):
        if a1=="远程正面通行":
            # 点击双面车道指示器状态---远程正面通行
            time.sleep(5)
    ...
    # 射流风机--------他是进行还原最初状态的
    def dl_zhjk_sbjk_lqk_030(self, a2, access_web):
        if a2 =="远程关":
            # 射流风机  远程关
            time.sleep(70)
            access_web[32].dl_zhjk_sbjk_lqk_05()
    ...
    def dl_zhjk_sbjk_lqk_031(self, a2, access_web):
        if a2 == "远程红":
            #洞口交通灯4控   远程红
            time.sleep(5)
    ...
    #加强照明----获取他的初始值
    #j基本照明
    def dl_zhjk_sbjk_lqk_035(self,a2,access_web):
    ...
    #可变速标志---速度设置
    @allure.step("情报板信息清空---")
    def dl_zhjk_sbjk_lqk_037(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_qbbxxqk))
        self.driver.find_element(*loc.dl_zhjk_sbjk_qbbxxqk).click()


    #情报板信息下发-----退出
    def dl_zhjk_sbjk_lqk_038(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_qbbxxxf_tc))
        self.driver.find_element(*loc.dl_zhjk_sbjk_qbbxxxf_tc).click()

    # 情报板信息下发-----用JS输入内容
    def dl_zhjk_sbjk_lqk_039(self):
        js='var a = document.getElementsByClassName("page")[1];var line = a.getElementsByClassName("line")[0];console.log(line);var span0 = line.getElementsByTagName("span");console.log(span0);if (span0.length <= 1){newspan=document.createElement("span");newspan.className="char";newspan.style.width="48px";newspan.style.height="96px";line.appendChild(newspan)};span0[span0.length-1].innerText="{123}"'
