...
class Test_zhjk_sbjk_qpl:
    ...
    # 提示语1---
    @allure.step("提示语1---")
    def dl_zhjk_sbjk_qpl_tsy1(self):
    ...
    #点击金家庄隧道
    @allure.step("点击金家庄隧道")
    def dl_zhjk_sbjk_qpl_01(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_qplsd))
        self.driver.find_element(*loc.dl_zhjk_sbjk_qplsd).click()


    #左侧搜索框
    @allure.step("左侧搜索框")
    def dl_zhjk_sbjk_qpl_02(self,ssk):
    ...
    #情报板信息下发---输入内容
    def dl_zhjk_sbjk_qpl_012(self,k1):
    ...
    # 可变速标志---速度设置
    def dl_zhjk_sbjk_qpl_016(self,r):
    ...
    #枪机 ---视频 点击X
    def dl_zhjk_sbjk_qpl_023(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_sdszssk_qx))
        self.driver.find_element(*loc.dl_zhjk_sbjk_sdszssk_qx).click()

    # 左下侧设备名称
    def dl_zhjk_sbjk_qpl_025(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_sdszssk_sd))
        return self.driver.find_elements(*loc.dl_zhjk_sbjk_sdszssk_sd)[0].text


    #路段点击设备组
    def dl_zhjk_sbjk_qpl_026(self):
    ...
    #点击键盘上的回车键
    def dl_zhjk_sbjk_qpl_027(self):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located(loc.dl_zhjk_sbjk_zcssk))
        self.driver.find_element(*loc.dl_zhjk_sbjk_zcssk).send_keys(Keys.ENTER)


    #双面车道指示器-------他是进行还原最初状态的
    def dl_zhjk_sbjk_qpl_029(self,a1,access_web):
        if a1=="远程正面通行":
            # 点击双面车道指示器状态---远程正面通行
            time.sleep(5)
    ...
    # 射流风机--------他是进行还原最初状态的
    def dl_zhjk_sbjk_qpl_030(self, a2, access_web):
        if a2 =="远程关":
            # 射流风机  远程关
            time.sleep(70)
            access_web[38].dl_zhjk_sbjk_qpl_05()
    ...
    def dl_zhjk_sbjk_qpl_031(self, a2, access_web):
        if a2 == "远程红":
            # 射流风机  远程红
            time.sleep(5)
    ...
    #加强照明----获取他的初始值
    #j基本照明
    def dl_zhjk_sbjk_qpl_035(self,a2,access_web):
